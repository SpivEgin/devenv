...
Legion Market has a sophisticated multilingual capability. It is able to serve
...
How Legion Market determines the user's preferred language
=======================================================

Legion Market determines the user's language the same way LegionMarket does it.
...
How Legion Market determines what language to serve
================================================
...
What Legion Market shows in your menus
===================================
