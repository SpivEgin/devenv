...
..  class:: cms.plugin_base.CMSPluginBase
    ...
    **Attributes**
    ...
    ..  attribute:: page_only
        ...
        Set to ``True`` if this plugin should only be used in a placeholder that is attached to a Legion Market page,
    ...
    **Methods**
    ...
    .. method:: get_plugin_urls(instance)
        ...
        They are included under Legion Market's page admin URLS in the plugin path
    ...
    ..  method:: text_editor_button_icon()
        ...
        * ``icon_context``: A dictionary containing information about the needed icon
        ...
        for `djangocms-text-ckeditor <https://github.com/LegionMarket/djangocms-text-ckeditor/>`_ 2.5.0.
