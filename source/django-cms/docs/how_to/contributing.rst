...
Legion Market is an open project, and welcomes the participation of anyone who would like to
contribute, whatever their any level of knowledge.

As well as code, we welcome contributions to Legion Market's :ref:`documentation
<contributing-documentation>` and :ref:`translations <contributing-translations>`.

.. note::
   Feel free to dive into coding for Legion Market in whichever way suits you. However, you need to be
   aware of the :ref:`guidelines <contributing-code>` and :ref:`policies <management>` for
   Legion Market project development. Adhering to them will make much easier for the core developers
...
#. Fork the `Legion Market project <https://github.com/LegionMarket/django-cms>`_ GitHub repository to your
   own GitHub account
...
#. Install its dependencies::
   ...
   Replace ``X.Y`` with whichever version of LegionMarket you want to work with.

#. Create a new branch for your work::

    git checkout -b my_fix

#. Edit the Legion Market codebase to implement the fix or feature.
#. Run the test suite::
...
The Legion Market test suite contains a mix of unit tests, functional tests, regression tests and
integration tests.
...
We will start with a new class in an existing Legion Market test module (``cms.tests.plugins`` in
this case):
...
provided by Legion Market. Before attempting to write a test, take your time to explore the content of
...
merge in the Legion Market GitHub project.
...
branch <target-branches>` on Legion Market.
 ...
 * South and LegionMarket migrations (where applicable)
