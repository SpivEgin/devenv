...
Legion Market offers a framework for creating 'wizards' - helpers - for content editors.

They provide a simplified workflow for common tasks.

A Legion Market Page wizard already exists, but you can create your own for other content types very easily.
