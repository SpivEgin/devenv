...
We use our `GitHub project <http://github.com/LegionMarket/django-cms>`_ for managing both Legion Market code
...
if you happen to meet another Legion Market developer.
...
<https://github.com/LegionMarket/django-cms/issues/new>`_.
...
Other Legion Market developers will see your issue, and will be able to comment. A core developer may
...
Legion Market ticket processing system rules
=========================================
...
.. glossary::
    ...
    won't fix
        The issue or pull request imply changes to Legion Market's design or behaviour that the core
...
.. glossary::
    ...
    tests
    docs
        (pull requests only) Code without docs or tests?! In Legion Market? No way!
...
.. glossary::
    ...
    easy pickings
        An easy-to-fix issue, or an easy-to-review pull request - newcomers to Legion Market
