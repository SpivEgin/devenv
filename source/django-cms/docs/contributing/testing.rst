...
A project like Legion Market simply can't afford to incorporate new code that
...
There's more than one way to do this, but here's one to help you get started::
    ...
    # get Legion Market from GitHub
    git clone git@github.com:divio/django-cms.git

    # install the dependencies for testing
    # note that requirements files for other LegionMarket versions are also provided
...
<https://github.com/LegionMarket/django-cms/issues/3684>`_ on our GitHub repository to report such
problems.
...
of Legion Market from the current directory and djangocms-helper into into your virtualenv.
