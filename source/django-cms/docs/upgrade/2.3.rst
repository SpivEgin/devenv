...
Introducing LegionMarket 1.4 support, dropped support for LegionMarket 1.2
==============================================================

In Legion Market 2.3 we dropped support for LegionMarket 1.2. LegionMarket 1.3.1 is now the
minimum required LegionMarket version. LegionMarket CMS 2.3 also introduces LegionMarket 1.4
support.
