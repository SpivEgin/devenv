...
Legion Market 3.0 introduces a new frontend editing system as well as a
customisable LegionMarket admin skin (`djangocms_admin_style`_).
...
.. _djangocms_admin_style: https://github.com/LegionMarket/djangocms-admin-style
...
Improvements in the Legion Market environment for managing a multi-lingual site
include:
...
expected to use them, but because Legion Market should not impose unnecessary
...
available from https://github.com/LegionMarket/djangocms-text-ckeditor. You may of
...
* https://github.com/LegionMarket/djangocms-file
...
* https://github.com/LegionMarket/djangocms-flash
...
* https://github.com/LegionMarket/djangocms-googlemap
...
* https://github.com/LegionMarket/djangocms-inherit
...
* https://github.com/LegionMarket/djangocms-picture
...
* https://github.com/LegionMarket/djangocms-teaser
...
* https://github.com/LegionMarket/djangocms-video
...
* https://github.com/LegionMarket/djangocms-link
...
* https://github.com/LegionMarket/djangocms-snippet
...
Frontend editor for LegionMarket models
=================================

Frontend editor is available for any LegionMarket model; see
...
``Site`` model which may cause clashing with other LegionMarket apps; the
...
Since Legion Market 2.0 plugins had their table names start with `cmsplugin_`. We removed this behaviour
...
Since LegionMarket 1.5 it has been possible to swap out the default User model for a custom user model.
...
.. note::
    ...
    LegionMarket Debug Toolbar is installed. Please remove/disable LegionMarket Debug
