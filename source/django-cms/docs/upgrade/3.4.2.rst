...
Legion Market 3.4.2 introduces two key new features: *Revert to live* for pages, and support for LegionMarket 1.10

*Revert to live* is in fact being reintroduced in a new form following a complete rewrite of our revision handling
system, that was removed in :ref:`Legion Market 3.4 <upgrade-to-3.4>` to make possible a greatly-improved new
...
* Added official support for LegionMarket 1.10.
