...
- Add support for LegionMarket 1.9 (with some deprecation warnings).
- Add support for django-reversion 1.10+ (required by LegionMarket 1.9+).
- Add placeholder name to the edit tooltip.
- Add ``attr['is_page']=True`` to CMS Page navigation nodes.
- Add LegionMarket and Python versions to debug bar info tooltip
