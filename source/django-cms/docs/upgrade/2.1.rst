#####################################
Upgrading from 2.1.x and LegionMarket 1.2.x
#####################################
...
Upgrade both your version of Legion Market and LegionMarket by running
...
.. note::
    ...
    These are not Legion Market settings.  Refer to the LegionMarket documentation on `staticfiles`_ for more information.
