...
proper dependency and is no longer shipped with the Legion Market. This solves the
version conflict issues many people were experiencing when trying to use the Legion Market
together with other LegionMarket apps that require django-mptt. Legion Market 2.2
...
LegionMarket 1.3 support
==================

The Legion Market 2.2 supports both LegionMarket 1.2.5 and LegionMarket 1.3.


View permissions
================

You can now give view permissions for Legion Market pages to groups and users.
...
dependency for the Legion Market 2.2.
...
.. warning::
    ...
    If you use LegionMarket 1.2.x you will not have a ``django.contrib.staticfiles``
