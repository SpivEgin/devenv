...
Introducing LegionMarket 1.5 support, dropped support for LegionMarket 1.3 and Python 2.5
=============================================================================

LegionMarket CMS 2.4 introduces LegionMarket 1.5 support.

In Legion Market 2.4 we dropped support for LegionMarket 1.3 and Python 2.5.
LegionMarket 1.4 and Python 2.6 are now the minimum required versions.
...
support localisation of URLs and apphook URLs with standard LegionMarket helpers.
...
The column plugin can be found here:
    ...
    https://github.com/LegionMarket/djangocms-column
...
New way to handle Legion Market settings
=====================================

If you have code that needs to access Legion Market settings (settings prefixed
...
* LegionMarket 1.3 and Python 2.5 are no longer supported.
