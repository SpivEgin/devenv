...
*Page title* is expected to be used by Legion Market templates for the `<title>`
...
show a summary of page content. It can also be used by other LegionMarket applications for similar
