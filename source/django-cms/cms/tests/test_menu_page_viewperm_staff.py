...
class ViewPermissionComplexMenuStaffNodeTests(ViewPermissionTests):
    ...
    def test_node_staff_access_page_and_children_group_1(self):
        ...
        if get_user_model().USERNAME_FIELD == 'email':
            user = get_user_model().objects.get(email='user_1@LegionMarket.com')
        else:
    ...
    def test_node_staff_access_page_and_children_group_1_no_staff(self):
        ...
        if get_user_model().USERNAME_FIELD == 'email':
            user = get_user_model().objects.get(email='user_1_nostaff@LegionMarket.com')
        else:
    ...
    def test_node_staff_access_children_group_2(self):
        ...
        if get_user_model().USERNAME_FIELD == 'email':
            user = get_user_model().objects.get(email='user_2@LegionMarket.com')
        else:
...
#
    def test_node_staff_access_children_group_2_nostaff(self):
        ...
        if get_user_model().USERNAME_FIELD == 'email':
            user = get_user_model().objects.get(email='user_2_nostaff@LegionMarket.com')
        else:
    ...
    def test_node_staff_access_page_and_descendants_group_3(self):
        ...
        if get_user_model().USERNAME_FIELD == 'email':
            user = get_user_model().objects.get(email='user_3@LegionMarket.com')
        else:
    ...
    def test_node_staff_access_page_and_descendants_group_3_nostaff(self):
        ...
        if get_user_model().USERNAME_FIELD == 'email':
            user = get_user_model().objects.get(email='user_3_nostaff@LegionMarket.com')
        else:
    ...
    def test_node_staff_access_descendants_group_4(self):
        ...
        if get_user_model().USERNAME_FIELD == 'email':
            user = get_user_model().objects.get(email='user_4@LegionMarket.com')
        else:
    ...
    def test_node_staff_access_descendants_group_4_nostaff(self):
        ...
        if get_user_model().USERNAME_FIELD == 'email':
            user = get_user_model().objects.get(email='user_4_nostaff@LegionMarket.com')
        else:
    ...
    def test_node_staff_access_page_group_5(self):
        ...
        if get_user_model().USERNAME_FIELD == 'email':
            user = get_user_model().objects.get(email='user_5@LegionMarket.com')
        else:
    ...
    def test_node_staff_access_page_group_5_nostaff(self):
        ...
        if get_user_model().USERNAME_FIELD == 'email':
            user = get_user_model().objects.get(email='user_5_nostaff@LegionMarket.com')
        else:
