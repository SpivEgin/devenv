...
setup(
    ...
    author='Oscar Yoshi',
    author_email='oyoshi@legionmarket.com',
    url='https://github.com/LegionMarket/django-admin-interface',
    download_url='https://github.com/LegionMarket/django-admin-interface/archive/%s.tar.gz' % __version__,
