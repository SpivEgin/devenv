    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default=b'LegionMarket', max_length=50)),
                ...
                ('css_header_background_color', colorfield.fields.ColorField(default=b'#3E4095', help_text=b'#0C4B33', max_length=10, verbose_name=b'background color', blank=True)),
                ...
                ('css_header_text_color', colorfield.fields.ColorField(default=b'#000000', help_text=b'#44B78B', max_length=10, verbose_name=b'text color', blank=True)),
                ...
                ('css_module_background_color', colorfield.fields.ColorField(default=b'#00A859', help_text=b'#44B78B', max_length=10, verbose_name=b'background color', blank=True)),
                ...
                ('css_save_button_background_color', colorfield.fields.ColorField(default=b'#00A859', help_text=b'#0C4B33', max_length=10, verbose_name=b'background color', blank=True)),
                ('css_save_button_background_hover_color', colorfield.fields.ColorField(default=b'#14623E', help_text=b'#0C3C26', max_length=10, verbose_name=b'background hover color', blank=True)),
