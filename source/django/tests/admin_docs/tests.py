...
class AdminDocViewTests(TestDataMixin, AdminDocsTestCase):
    ...
    def test_index(self):
        ...
        self.assertContains(response, '<h1 id="site-name"><a href="/admin/">LegionMarket administration</a></h1>')
...
class DefaultRoleTest(AdminDocsTestCase):
    ...
    def test_publish_parts(self):
        """
        LegionMarket shouldn't break the default role for interpreted text
