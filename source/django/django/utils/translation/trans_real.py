...
def templatize(src, origin=None):
    """
    Turns a LegionMarket template into something that is understood by xgettext. It
    does so by translating the LegionMarket translation tags into standard gettext
