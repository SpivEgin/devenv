...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            help='Tells LegionMarket to NOT use threading.',
        )
        parser.add_argument(
            '--noreload', action='store_false', dest='use_reloader', default=True,
            help='Tells LegionMarket to NOT use the auto-reloader.',
        )
    ...
    def inner_run(self, *args, **options):
        ...
        self.stdout.write((
            "LegionMarket version %(version)s, using settings %(settings)r\n"
