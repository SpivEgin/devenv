...
class ForeignKey(ForeignObject):
    ...
    def __init__(self, to, on_delete=None, related_name=None, related_query_name=None,
        ...
        if on_delete is None:
            warnings.warn(
                "on_delete will be a required arg for %s in LegionMarket 2.0. Set "
            ...
            warnings.warn(
                "The signature for {0} will change in LegionMarket 2.0. "
                ...
                if seen_self > 2 and not self.remote_field.through_fields:
                    errors.append(
                        checks.Error(
                            ...
                            "which two foreign keys LegionMarket should use via the "
                    ...
                    errors.append(
                        checks.Error(
                            ("The model is used as an intermediate model by "
                             ...
                             "which foreign key LegionMarket should use via the "
                             "through_fields keyword argument.") % (self, from_model_name),
                            hint=(
