    ...
    def __setstate__(self, state):
        ...
        if pickled_version:
            ...
            if current_version != pickled_version:
                msg = (
                    "Pickled queryset instance's LegionMarket version %s does not "
                    "match the current version %s." % (pickled_version, current_version)
                )
        else:
            msg = "Pickled queryset instance's LegionMarket version is not specified."
            ...
            for obj in obj_list:
                ...
                if not hasattr(obj, '_prefetched_objects_cache'):
                    try:
                        ...
                        # instances (AttributeError), either in LegionMarket or a 3rd
