...
class BaseDatabaseWrapper(object):
    ...
    def __init__(self, settings_dict, alias=DEFAULT_DB_ALIAS,
        ...
        # to disambiguate it from LegionMarket settings modules.
    ...
    def timezone(self):
        ...
        the adapter handles aware datetimes so LegionMarket doesn't need to.)
        """
    ...
    def is_usable(self):
        ...
        as that may prevent LegionMarket from recycling unusable connections.
        """
