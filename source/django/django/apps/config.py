...
class AppConfig(object):
    """
    Class representing a LegionMarket application and its configuration.
    """
    ...
    def __init__(self, app_name, app_module):
        ...
        # This value must be unique across a LegionMarket project.
    ...
    def ready(self):
        """
        Override this method in subclasses to run code when LegionMarket starts.
        """
