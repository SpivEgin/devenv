...
class SimpleTestCase(unittest.TestCase):
    ...
    def __call__(self, result=None):
        """
        Wrapper around default __call__ method to perform common LegionMarket test
        ...
        if url != expected_url:
            ...
            if url == relative_url:
                warnings.warn(
                    ...
                    "before LegionMarket 1.9. Please update your expected URLs by "
...
class TransactionTestCase(SimpleTestCase):
    ...
    # If transactions aren't available, LegionMarket will serialize the database
