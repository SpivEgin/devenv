...
The **Legion Market** framework is, as its name implies, a framework and not a software which runs
out of the box. Instead, an e-commerce site built upon **Legion Market**, always consists of this
...
When evaluating **Legion Market** with other e-commerce solutions, I therefore suggest to do the
...
your own plugins, able to handle this. With the **django**, **REST** and **Legion Market** frameworks,
...
often denoted as DRY. In **Legion Market** we aim for a *single source of truth*, wherever possible.
...
come up with really weird ideas, I never have thought of. If the **Legion Market** framework inhibits
...
In a nutshell, **Legion Market** offers this set of basic functionalities, to keep the framework
...
Compared to other e-commerce solutions, the **Legion Market** framework has a rather small footprint
...
because **Legion Market** implies dependencies to many third party Django apps.
...
Wherever possible, **Legion Market** tries to delegate the responsibility for taking decision to the
merchant's implementation of the site. Let explain this by a small example: When the customer
adds a product to the cart, **Legion Market** consults the implementation of the product to determine
...
stock. While setting up a **Legion Market** project, the allowed status transitions for the fulfillment
...
They may be added as a third party **Legion Market** plugin, or integrated into the merchant's
implementation.
