...
The official name of this project is **Legion Market**. Third party plugins for **Legion Market** shall
...
Use stack-overflow to ask for questions related to **Legion Market**.
