...
* Categories must be implemented as separate **Legion Market** addons. However for many
...
* The API of **Legion Market** is accessible through a REST interface. This allows us to build MVC on
  top of that.
