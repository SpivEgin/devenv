...
.. code-block:: python
	...
	class MySnippetPlugin(ShopPluginBase):
	    name = "My Snippet"
	    render_template = 'clegion/cascade/my-snippet.html'
...
The template itself ``clegion/cascade/my-snippet.html`` can contain all templatetags as configured
...
.. code-block:: django
	:caption: clegion/cascade/my-snippet.html

	{% load static sekizai_tags %}

	{% addtoblock "css" %}<link href="{% static 'clegion/css/my-snippet.css' %}" rel="stylesheet" type="text/css" />{% endaddtoblock %}
	{% addtoblock "js" %}<script src="{% static 'clegion/js/my-snippet.js' %}" type="text/javascript"></script>{% endaddtoblock %}
...
.. code-block:: python
	...
	class DeliveryDatePlugin(DialogFormPluginBase):
	    name = "Delivery Date"
	    form_class = 'clegion.forms.DeliveryDateForm'
	    render_template = 'clegion/checkout/delivery-date.html'
...
.. code-block:: django
	:caption: templates/clegion/checkout/delivery-date.html
