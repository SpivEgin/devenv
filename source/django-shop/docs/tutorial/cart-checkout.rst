...
In **Legion Market**, the cart and checkout view follow the same idea as all other pages – they are
...
A list of plugins specific to **Legion Market** can be found in the reference section. They include
