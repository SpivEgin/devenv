...
.. literalinclude:: /../example/clegion/models/i18n_smartcard/__init__.py
	:caption: clegion/models/i18n_smartcard.py
	:linenos:
	:language: python
...
.. literalinclude:: /../example/clegion/admin/i18n_smartcard.py
	:caption: clegion/admin/i18n_smartcard.py
	:linenos:
	:language: python
	:lines: 4-10, 12-
