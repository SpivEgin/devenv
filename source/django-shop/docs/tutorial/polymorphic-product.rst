...
To enable polymorphic models in **Legion Market**, we require the application django-polymorphic_.
...
.. literalinclude:: /../example/clegion/models/polymorphic_/product.py
    :caption: clegion/models/i18n/polymorphic/product.py
...
**Legion Market** is shipped without any prepared model for it. If we want to sell both Smart Cards
...
.. literalinclude:: /../example/clegion/models/polymorphic_/smartcard.py
    :caption: clegion/models/i18n/polymorphic/smartcard.py
    :linenos:
    :language: python
    :lines: 4-8, 10-24
...
.. literalinclude:: /../example/clegion/models/polymorphic_/smartphone.py
    :caption: clegion/models/polymorphic/smartphone.py
    :linenos:
    :language: python
    :lines: 7-10, 20-44
...
.. code-block:: python
    :caption: clegion/models/commodity.py
    :name: commodity-model

    from cms.models.fields import PlaceholderField
    from clegion.models.product import Product
...
Since the **Legion Market** framework looks in the folder ``catalog`` for a template named after its
product class, adding this HTML snippet should do the job:

.. code-block:: django
    :caption: clegion/catalog/commodity-detail.html

    {% extends "clegion/pages/default.html" %}
    {% load cms_tags %}
