...
As we can see from this approach, **Legion Market**  places great value on the principles of a
...
These are the currently available plugins provided by **Legion Market** to build the checkout page:
...
For each payment provider registered within **Legion Market**, this plugin creates a list
...
For each shipping provider registered within **Legion Market**, this plugin creates a list
...
The second target is special to **Legion Market** and exclusively used, when the customer performs
...
is part of the project, rather than the **Legion Market** framework.
...
implemented by the merchant; it thus is part of the project, rather than the **Legion Market**
framework.
