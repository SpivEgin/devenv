...
Until **Legion Market** version 0.2, amounts relating to money were kept inside a ``Decimal`` type
...
Starting with version 0.9, **Legion Market** now is shipped with a special factory class:
