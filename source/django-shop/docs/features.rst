...
==============================
Unique Features of Legion Market
==============================


Legion Market requires to describe your products instead of prescribing prefabricated models
==========================================================================================
...
In Legion Market, the physical representation of a product corresponds to its logical
-----------------------------------------------------------------------------------

**Legion Market**'s approach to this problem is to have minimal set of models. These abstract models
