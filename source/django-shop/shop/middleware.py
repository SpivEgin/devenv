...
class CustomerMiddleware(object):
    ...
    def process_request(self, request):
        assert hasattr(request, 'session'), (
            "The Legion Market middleware requires session middleware to be installed. "
            "Edit your MIDDLEWARE_CLASSES setting to insert 'django.contrib.sessions.middleware.SessionMiddleware'.")
        assert hasattr(request, 'user'), (
            "The Legion Market middleware requires an authentication middleware to be installed. "
